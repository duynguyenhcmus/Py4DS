...
Py4DS_Lab5_Dataset/titanic_test.csv'
    ...
    path_gender='https://raw.githubusercontent.com/duynguyenhcmus/Py4DS/main/Lab5/\
Py4DS_Lab5_Dataset/gender_submission.csv'
    ...
    y_train=df['Survived']
    X_test=df_test
    y_test=df_gender.drop(['PassengerId'],axis=1)
    ...
    #Random Forest
    accuracy_forest=random_forest(X_train,y_train,X_test,y_test)
    print("Accuracy of Random Forest: ",accuracy_forest)
    '''
        Summary:
            Accuracy of Logistic Regression:  0.9114832535885168
            Accuracy of AdaBoostClassifier:  0.8636363636363636
            Accuracy of Random Forest:  0.916267942583732
    '''
